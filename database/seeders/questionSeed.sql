...
INSERT INTO questions (product_id, id, category, text, votes) VALUES
  (1, 1, 'furniture', 'what is this couch used for?', 0),
  (1, 2, 'furniture', 'Does this couch pull out?', 2),
  (2, 3, 'furniture', 'Does this mattress squeak?', 3),
  (3, 4, 'furniture', 'How many times can you fold it?', 2),
  ...
  (10, 11, 'furniture', 'This is a one nightstand?', 10),
  ...
  (22, 26, 'furniture', 'Did you mean, beer pong table?', 2),
